            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="relative">
                <button
                  ...
                  className="p-1 sm:p-2 rounded-full hover:bg-slate-800 transition-colors relative"
                >
                ...
                {showNotifications && notifications.length > 0 && (
                  <div className="absolute right-0 mt-2 w-64 sm:w-72 bg-white rounded-md shadow-lg overflow-hidden z-50">
                    <div className="py-2">
                      <div className="px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-700 bg-gray-100 flex justify-between items-center">
                      ...
                      <div className="max-h-60 overflow-y-auto">
                        {notifications.map((notification, index) => (
                          <div key={index} className="px-3 sm:px-4 py-3 text-xs sm:text-sm border-b hover:bg-gray-50 relative">
                            <button 
                              onClick={async () => {
                                try {
                                  if (notification._id) {
