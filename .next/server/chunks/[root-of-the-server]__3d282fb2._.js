...
"[project]/.next-internal/server/app/api/db-migrate/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/src/app/api/db-migrate/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST() {
    try {
        ...
        const testConnection = await __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].createConnection(testUri);
        console.log('📊 Connecting to jmtracking database...');
        const prodConnection = await __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].createConnection(prodUri);
        // Define contract schema for both connections
        const contractSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema({
            phone_number: String,
            lot_number: String,
            full_name: String,
            address: String,
        ...
        const existingLots = await ProdContract.find({}, {
            lot_number: 1
        }).lean();
        const existingLotNumbers = new Set(existingLots.map((c)=>c.lot_number));
        // Filter out contracts that already exist in production
        const contractsToMigrate = testContracts.filter((contract)=>!existingLotNumbers.has(contract.lot_number));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3d282fb2._.js.map